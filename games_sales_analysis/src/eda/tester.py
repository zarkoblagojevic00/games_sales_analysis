...
class GamesSalesTester:
    def __init__(self, x, y):
        self.x_train, self.y_train, self.x_test, self.y_test = self.__train_test_split(x, y)
        self.classifiers = {
            'My Logistic Regression': OneVsRestClassifier(MyLogReg()),
    ...
    def __train_test_split(self, x, y):
        ...
        x_train, x_test, y_train, y_test = train_test_split(x_norm, y, test_size=.3, random_state=0)
